                    ...
                    <div class="table-responsive">
                        <table id="table-detail" class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    <td>{{trans('crudbooster.name_lastname')}}</td><td>{{ $lead->name }} {{ $lead->lFastname }}</td>
                        ...
                        <div class="container-fluid">
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" title="{{trans('crudbooster.date_due')}}" required class="form-control date_task" name="date" id="date" value="">
                                    </div>
                                </div>
