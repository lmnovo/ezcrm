        ...
        @foreach($result as $row)
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-xs btn-primary btn-detail" title="Detail Data" href="http://ezcrm.us/crm/account/detail/{{$row->id}}?return_url=http%3A%2F%2F127.0.0.1%3A8000%2Fcrm%2Faccount%3Fm%3D62"><i class="fa fa-eye"></i></a>
                </td>
            </tr>
        @endforeach
        </tbody>
