...
@section('content')
    ...
    <script src="http://18.220.213.59/js/categorias_productos.js"></script>
    <script src="http://18.220.213.59/js/subcategorias_productos.js"></script>
            ...
            $('a#appliance_list_edit').on('click',function(e){
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        ...
                        $('#appliance_imagen').attr('src','http://18.220.213.59/assets/images/appliances/'+data[0].imagen);
        ...
        <table id="products_table" class='table table-hover table-striped table-bordered table_class_products'>
            ...
            @foreach($result as $row)
                <tr>
                    ...
                    <td style="width: 6%">
                        <a data-lightbox="roadtrip" rel="group_{products}" title="{{$row->description}}" href="http://18.220.213.59/assets/images/appliances/{{$row->imagen}}">
                            <img width="40px" height="40px" src="http://18.220.213.59/assets/images/appliances/{{$row->imagen}}">
                        </a>
                    </td>
                    ...
                    <td style="width: 7%; text-align: center;">
                        ...
                        <a class="btn btn-xs btn-warning btn-delete" title="{{trans('crudbooster.delete')}}" href="javascript:;" onclick="swal({
                                ...
                                function(){
                                location.href='http://18.220.213.59/crm/products/delete/{{ $row->id }}'
