            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="padding:20px 0px 0px 0px">
                    <form class='form-horizontal' method='get' id="form" enctype="multipart/form-data" action='{{CRUDBooster::adminpath("account/saved")}}'>
                        ...
                        <input type='hidden' name='return_url' value='http://ezcrm.us/crm/account?m=50'/>
                        <input type='hidden' name='ref_mainpath' value='http://ezcrm.us/crm/account'/>
                        <input type='hidden' name='ref_parameter' value='return_url=http://ezcrm.us/crm/account?m=50&amp;parent_id=&amp;parent_field='/>
