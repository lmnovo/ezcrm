    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <!--GESTION DE IDIOMA-->
                <li class="dropdown messages-menu"><a href="<?php echo e(url('lang', ['en'])); ?>"><img style="width:25px" src="<?php echo e(asset('assets/images/us.png')); ?>" alt="EN"></a></li>
                <li class="dropdown messages-menu"><a href="<?php echo e(url('lang', ['es'])); ?>"><img style="width:25px" src="<?php echo e(asset('assets/images/es.png')); ?>" alt="ES"></a></li>
                <!--END-->
